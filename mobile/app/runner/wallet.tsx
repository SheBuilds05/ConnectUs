...
const styles = StyleSheet.create({
  ...
  bonusCard: { backgroundColor: '#ffffff', padding: 20, borderRadius: 20, borderWidth: 1, borderColor: '#f3f4f6' }, // ✅ FIXED: borderWeight → borderWidth
  ...
  transactionDetails: { flex: 1, marginLeft: 10 }, // ✅ FIXED: removed inline style with 'ml', created StyleSheet property
